...
class _SetReminderViewState extends State<SetReminderView> {
  ...
  Future<void> _selectTime() async {
    ...
    if (picked != null) {
      if (_selectedDate != null) {
        final selectedDateTime = DateTime(_selectedDate!.year, _selectedDate!.month, _selectedDate!.day, picked.hour, picked.minute);
        ...
        if (truncatedSelected.isBefore(truncatedNow)) {
          if (mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Cannot select a past time')));
          return;
        }
      }
  ...
  Future<void> _saveReminder() async {
    ...
    if (_selectedVehicleId == null || _selectedCategory == null || _selectedDate == null || _selectedTime == null) {
    ...
    final malaysiaDueDateTime = DateTime(_selectedDate!.year, _selectedDate!.month, _selectedDate!.day, _selectedTime!.hour, _selectedTime!.minute);
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Reminder saved successfully!')));
